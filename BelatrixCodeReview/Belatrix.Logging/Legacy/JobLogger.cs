...
public class JobLogger
{
    ...
    [Obsolete("Belatrix: This class is now obsolete due to new implementation using SOLID principles.", true)]
    public static void LogMessage(string message, bool info, bool warning, bool error)
    {
        message.Trim();
        ...
        if ((!_logError && !_logMessage && !_logWarning) || (!info && !warning && !error))
        {
